...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div class="page-content header-clear-small"> 
            ...
            <img src="{{asset('images/pictures/13.jpg')}}" class="img-fluid mb-n4">
		<a href="#" style="z-index:1;" class="position-relative"><img data-menu="menu-story" src="{{ url('/') }}{{Auth::user()->pegawai->photo}}" width="150" class="mx-auto border-l border-blue-dark rounded-circle mt-n5"></a>
		<h1 class="text-center font-20 pt-2 mb-0">{{Auth::user()->pegawai->nama_lengkap}}</h1>
		<p class="text-center mb-2">NIP : {{Auth::user()->pegawai->nip}}</p>
		...
		<div class="card card-style">
			<div class="content mt-2 pt-1">
				<div class="d-flex">
					<div>
						<h4>Intro</h4>
						<p class="pb-2">
							I build awesome mobile PWA's that make your site look and feel like an app!
						</p>
					</div>
					<div class="ms-auto">
						<a href="#"></a>
				...
				<div class="list-group list-custom-small ms-n1 mt-n1">
					<a href="#" class="border-0 mb-n3">
						<i class="fa font-14 fa-heart color-theme opacity-30"></i>
						<span>Married to <u class="font-800 text-decoration-none">Jane Handsome</u></span><i class="fa"></i>
					</a>
					<a href="#" class="border-0 mb-n3">
						<i class="fa font-14 fa-clock color-theme opacity-30"></i>
						<span>Author since January 2009<i class="fa"></i>
					</a>
					<a href="#" class="border-0 mb-n3">
						<i class="fa font-14 fa-briefcase color-theme opacity-30"></i>
						<span>Works at <u class="font-800 text-decoration-none">Enabled</u></span><i class="fa"></i>
					</a>
					<a href="#" class="border-0 mb-n3">
						<i class="fa font-14 fa-map-marker color-theme opacity-30"></i>
						<span>Lives in <u class="font-800 text-decoration-none">Europe</u></span><i class="fa"></i>
					</a>
				</div>
			</div>
		</div>
            ...
            <div class="card card-style">
                <div class="content">
                    ...
                    <div class="row mb-0 text-center">
                        <a href="#" data-menu="instant-2" class="col-4">
                            <i class="fa fa-calendar-alt font-30 color-red-dark"></i>
                            <p class="font-11 font-700 text-uppercase">Absen</p>
                        </a>
                        <a href="#" data-menu="instant-2" class="col-4">
            ...
            <div class="footer card card-style">
                <a href="#" class="footer-title"><span class="color-highlight">Absensi Online</span></a>
                <p class="footer-text"><span>Made with <i class="fa fa-heart color-highlight font-16 ps-2 pe-2"></i> by HMsyah23</span></p>
                <div class="text-center mb-3">
                    <a href="https://web.facebook.com/people/DKP3A-Provinsi-Kaltim/100064628984596/" class="icon icon-xs rounded-sm shadow-l me-1 bg-facebook"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/dkp3a.kaltim" class="icon icon-xs rounded-sm shadow-l me-1 bg-twitter"><i class="fab fa-instagram"></i></a>
                    <a href="https://dkp3a.kaltimprov.go.id" data-menu="menu-share" class="icon icon-xs rounded-sm me-1 shadow-l bg-red-dark"><i class="fa fa-globe"></i></a>
        ...
        <a href="#" class="close-menu btn bg-highlight btn-full btn-m rounded-s text-uppercase font-900 me-2 ms-2 mt-2">Close Article</a>
        
        <a href="#" class="card card-style me-2 ms-2 mt-3 mb-0 bg-29" data-card-height="400">
            <div class="card-center text-center">
                <h1 class="color-white mb-0 font-30">Instant Article 2</h1>
                <p class="color-white mb-0">Fast Loading and Absolutely Awesome</p>
            </div>
        ...
        <div class="content">
            <p>
                Instant articles support any content. Designed to load in a hearbeat. They are always present on the page, and work like a charm. We filled them up with contet for a demo.
            </p>

            <a href="#" class="shareToFacebook icon icon-xs rounded-s bg-facebook"><i class="fab fa-facebook-f"></i></a>
            <a href="#" class="shareToTwitter icon icon-xs rounded-s bg-twitter"><i class="fab fa-twitter"></i></a>
            <a href="#" class="shareToWhatsApp icon icon-xs rounded-s bg-whatsapp"><i class="fab fa-whatsapp"></i></a>
            <a href="#" class="shareToMail icon icon-xs rounded-s bg-mail"><i class="fa fa-envelope"></i></a>
            ...
            <p>
                This page is not WordPress, it's an HTML website. Yes, that's right. but you can convert it to WordPress yourself or hire an expert from Envato Studio.
            </p>

            <div class="row">
                <div class="col-4">
                    <a href="images/pictures/9t.jpg"  class="external-link filtr-item" title="Sweet Creams"><img src="images/empty.png" data-src="images/pictures/21s.jpg" class="preload-img shadow-s img-fluid rounded-s" alt="img"></a>
                </div>
                <div class="col-4">
                    <a href="images/pictures/14t.jpg"  class="external-link filtr-item" title="Sweet Creams"><img src="images/empty.png" data-src="images/pictures/14s.jpg" class="preload-img shadow-s img-fluid rounded-s" alt="img"></a>
                </div>
                <div class="col-4">
                    <a href="images/pictures/18t.jpg"  class="external-link filtr-item" title="Sweet Creams"><img src="images/empty.png" data-src="images/pictures/18s.jpg" class="preload-img shadow-s img-fluid rounded-s" alt="img"></a>
                </div>
            </div>
            ...
            <p class="opacity-90 pb-0 mb-0">I'm set to 90% opacity.</p>
            <p class="opacity-80 pb-0 mb-0">I'm set to 80% opacity.</p>
            <p class="opacity-70 pb-0 mb-0">I'm set to 70% opacity.</p>
            <p class="opacity-60 pb-0 mb-0">I'm set to 60% opacity.</p>
            <p class="opacity-50 pb-0 mb-0">I'm set to 50% opacity.</p>
            <p class="opacity-40 pb-0 mb-0">I'm set to 40% opacity.</p>
            <p class="opacity-30 pb-0 mb-0">I'm set to 30% opacity.</p>
            <p class="opacity-20 pb-0 mb-0">I'm set to 20% opacity.</p>
            <p class="opacity-10 pb-0 mb-0">I'm set to 10% opacity.</p>
            ...
            <p class="font-100 pb-0 mb-0">This text is set to 100 weight.</p>
        ...
        <a href="#" class="close-menu btn bg-highlight btn-full btn-m rounded-s text-uppercase font-900 me-3 ms-3 mt-2 mb-3">Close Article</a>
    </div>
    
        <div id="snackbar-cart" class="snackbar-toast rounded-m bg-green-dark" data-bs-delay="1200" data-bs-autohide="true"><i class="fa fa-shopping-bag me-3"></i>Added to Shopping Cart</div>
        <div id="snackbar-favorites" class="snackbar-toast rounded-m bg-red-dark" data-bs-delay="1200" data-bs-autohide="true"><i class="fa fa-heart me-3"></i>Saved to Favorites</div>
