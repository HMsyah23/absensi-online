...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div class="timeline-cover timeline-cover-center">
            <div data-card-height="230" class="card shadow-l preload-img" data-src="{{ url('/') }}{{ Auth::user()->pegawai->photo }}">
                <div class="card-center text-center">
                    <h2 class="color-white">{{ Auth::user()->pegawai->nama_lengkap }}</h2>
		...
		<div class="timeline-body">
            ...
            <div class="timeline-item mt-4">
                ...
                <div class="timeline-item-content rounded-s">
                    <h5 class="font-300 text-center mb-3">
                        Stop saying pink is the new black! Pink is just pink! Seriously! <a href="#">#funnyRant</a>
                    </h5>
                    <p class="text-center mb-0 pb-0">
                        <a href="#" class="icon icon-xxs rounded-xl bg-red-dark"><i class="fa fa-heart"></i></a>
                        <a href="#" class="icon icon-xxs rounded-xl bg-blue-dark me-3 ms-3"><i class="fa fa-sync"></i></a>
                        <a href="#" class="icon icon-xxs rounded-xl bg-green-dark"><i class="fa fa-envelope"></i></a>
                    </p>
                </div>
            </div>					
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-item-content-full rounded-s">
                    <img data-src="images/pictures/9w.jpg" alt="img" src="images/empty.png" class="preload-img rounded-s img-fluid">
                    <h5 class="font-300 text-center pt-3">
                        Our first Photo on Google Plus. We're adding stuff here too now!
                    </h5>
                    <a href="#" class="btn btn-s btn-center-l rounded-s bg-facebook text-uppercase font-900 mt-3 mb-3">Follow on Facebook</a>
                </div>
            </div>		
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-item-content rounded-s">
                    ...
                    <a href="#" class="btn btn-s btn-center-l rounded-s bg-pinterest text-uppercase font-900 mt-3 mb-2">Pinned from Pinterest</a>
                </div>
            </div>	
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-item-content rounded-s">
                    ...
                    <p class="text-center mt-3 mb-0 pb-0">
                        <a href="#">Follow us @iEnabled via Twitter for iOS</a>
                    </p>
                </div>
            </div>	
        </div>	
            ...
            <div class="footer card card-style">
                <a href="#" class="footer-title"><span class="color-green-dark">Absensi Online</span></a>
                <p class="footer-text"><span>Made with <i class="fa fa-heart color-green-dark font-16 ps-2 pe-2"></i>
                        by HMsyah23</span></p>
                <div class="text-center mb-3">
                    <a href="https://web.facebook.com/people/DKP3A-Provinsi-Kaltim/100064628984596/"
                        class="icon icon-xs rounded-sm shadow-l me-1 bg-facebook"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/dkp3a.kaltim"
                        class="icon icon-xs rounded-sm shadow-l me-1 bg-twitter"><i class="fab fa-instagram"></i></a>
                    <a href="https://dkp3a.kaltimprov.go.id" data-menu="menu-share"
                        class="icon icon-xs rounded-sm me-1 shadow-l bg-red-dark"><i class="fa fa-globe"></i></a>
