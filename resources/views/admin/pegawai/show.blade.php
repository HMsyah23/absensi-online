...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-1">
            ...
            <a href="{{route('admin.pegawais')}}" class="active-nav"><i class="fa fa-users"></i><span>Data Pegawai</span></a>
        ...
        <div class="page-content header-clear-medium">
            ...
            <div class="card card-style">
                <div class="content mb-2">
                    ...
                    <table id="myTable" class="table table-borderless text-center rounded-sm shadow-l" style="overflow: hidden;">
                        <thead>
                            <tr class="bg-gray-dark">
                                <th scope="col" class="color-white">No</th>
                                <th scope="col" class="color-white">NIP</th>
  ...
  crossorigin="anonymous"></script>
    ...
    <script>
        ...
        let token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
            URL = `{{url('/')}}`;
            $('#myTable').DataTable({
                    "ajax": `${URL}/api/pegawais`,
                    "columns": [
                        {"data": "id" , render : function ( data, type, row, meta ) {
                        return type === 'display'  ? `${row.id-1}` :
                            data;
                        }},
                    {"data": "nip" },
                    {"data": "nama_lengkap" },
                    ...
                    {"data": "no_hp" , render : function ( data, type, row, meta ) {
                        return type === 'display'  ? `
                            <a href="#" class="me-3 mb-3 icon icon-s rounded-sm bg-facebook"><i class="fas fa-eye"></i></a>
                            <a href="#" class="me-3 mb-3 icon icon-s rounded-sm bg-green-dark"><i class="fas fa-edit"></i></a>
                            <a href="#" class="me-3 mb-3 icon icon-s rounded-sm bg-pinterest"><i class="fas fa-trash"></i></a>
                        ` :
                            data;
                        }},
                    ],
