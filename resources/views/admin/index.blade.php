...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-1">
            <a href="{{route('admin.dashboard')}}" class="active-nav"><i class="fa fa-home"></i><span>Dashboard</span></a>
        ...
        <div class="page-content header-clear-medium">
                ...
                <div class="row mb-n2">
                    <div class="col-4 pe-2">
                        <div class="card card-style mx-0 mb-3">
                            <div class="p-3">
                                <h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2">Tidak Hadir</h4>
                    ...
                    <div class="col-4 ps-2 pe-2">
                        <div class="card card-style mx-0 mb-3">
                            <div class="p-3">
                                <h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2">Sedang Bekerja</h4>
                    ...
                    <div class="col-4 ps-2">
                        <div class="card card-style mx-0 mb-3">
                            <div class="p-3">
                                <h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2">Selesai Bekerja</h4>
            ...
            <div class="row text-center mb-0">
                <a href="{{ route('admin.pegawais') }}" class="col-12 col-sm-4">
                    <div class="card card-style mb-2">
                        <i class="fa fa-users color-green-dark fa-3x mt-5"></i>
                        <h1 class="pt-4">Data Pegawai</h1>
                        <p class="font-11 opacity-50 mt-n1">Data Pegawai DKP3A</p>
                        <p class="mb-0 pb-0 font-10 opacity-40">Ketuk untuk Lihat</p>
                    </div>
                </a>
                <a href="{{ route('admin.pengaturan') }}" class="col-12 col-sm-4">
                    <div class="card card-style mb-3">
                        <i class="fa fa-cog color-blue-dark fa-3x mt-5"></i>
                        <h1 class="pt-4">Pengaturan</h1>
                        <p class="font-11 opacity-50 mt-n1">Pengaturan Sistem Absensi Online</p>
                        <p class="mb-0 pb-0 font-10 opacity-40">Ketuk untuk Lihat</p>
                    </div>
                </a>
                <a href="{{ route('admin.laporan') }}" class="col-12 col-sm-4">
                    <div class="card card-style mb-2">
                        <i class="fa fa-file-pdf color-magenta-dark fa-3x mt-5"></i>
                        <h1 class="pt-4">Laporan</h1>
                        <p class="font-11 opacity-50 mt-n1">Laporan Absensi</p>
                        <p class="mb-0 pb-0 font-10 opacity-40">Ketuk untuk Lihat</p>
                    </div>
                </a>
            </div>
