...
<head>
    ...
    <title>Absensi Online | Pengaturan</title>
...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-1">
            ...
            <a href="{{route('admin.pengaturan')}}" class="active-nav"><i class="fa fa-cog"></i><span>Pengaturan</span></a>
        ...
        <div class="page-content header-clear-medium">
            ...
            <div class="card card-style">
                <div data-card-height="250" class="card mb-0 preload-img" data-src="{{asset('images/pictures/_bg-infinite.jpg')}}">
                    <div class="card-center text-center">
                        <h1 class="color-white mb-0 font-40">Pengaturan</h1>
                        <p class="opacity-50 color-white mb-0">Konfigurasi Keseluruhan Sistem Absensi Online</p>
                    </div>
                ...
                <div class="content mt-0 mb-0">
                    <div class="list-group list-custom-large list-icon-0">
                        <a data-menu="settings-pane" href="#">
                            <i class="fa font-19 fa-wifi rounded-s color-blue-dark"></i>
                            <span>Connections</span>
                            <strong>Details about your Connections</strong>
                            <i class="fa fa-chevron-right opacity-30 mt-1"></i>
                        </a>        
                        <a data-menu="settings-pane" href="#">
                            <i class="fa font-19 fa-moon rounded-s color-gray-dark"></i>
                            <span>Do Not Disturb</span>
                            <strong>Turn on Do no Disturb Mode</strong>
                            <i class="fa fa-chevron-right opacity-30 mt-1"></i>
                        </a>        
                        <a data-menu="settings-pane" href="#">
                            <i class="fa font-19 fa-broadcast-tower rounded-s color-green-dark"></i>
                            <span>Celular Data</span>
                            <strong>Turn off Conectons from Celluar</strong>
                ...
                <div class="content mb-0 mt-0">
                    <div class="list-group list-custom-large list-icon-0">
                        <a data-toggle-theme data-trigger-switch="switch-21" href="#">
                            <i class="fa font-19 fa-lightbulb rounded-s color-yellow-dark"></i>
                            <span>Dark Mode</span>
    ...
    <div id="settings-pane" class="menu menu-bg menu-box-bottom notch-clear" data-menu-width="cover" data-menu-height="cover">
        
        <div class="card card-style mt-3 pb-2">
            <div class="menu-title">
                <h1 class="font-20">This is a Settings Window</h1>
                <p class="color-highlight pt-1">Create the Settings Page you Always Wanted</p>
                <a href="#" class="close-menu"><i class="fa fa-times-circle"></i></a>
            </div>
        </div>
        
        <div class="card card-style mt-4">
            <div data-card-height="350" class="card bg-18">
                <div class="card-center text-center">
                    <h1 class="color-white mb-0 font-30">Infinite Possibilities</h1>
                    <p class="color-white boxed-text-l mt-3 mb-0 opacity-60">
                        Create Any Settings page you need. With any component you want. 
                    </p>
                </div>
                <div class="card-overlay bg-black opacity-80"></div>
            </div>  
        ...
        <div class="card card-style mt-3">
            ...
            <div class="content">
                <p>
                    This settings panel supports infinite windows. You can create however many you wish and all of them support 
                    all the features included in our item.
                </p>
        ...
        <a href="#" class="close-menu btn btn-full btn-m mt-4 me-3 ms-3 mb-4 bg-highlight font-900 text-uppercase rounded-s">Back to Settings</a>
    </div>
